...
abstract class AbstractSACParser implements SACParser {
    ...
    protected CSSParseException toCSSParseException(final String key, final ParseException e) {
        final String messagePattern1 = getSACParserMessages() == null ? "Invalid token \\\"{0}\\\". Was expecting: {1}." : getSACParserMessages().getString("invalidExpectingOne");
        final String messagePattern2 = getSACParserMessages() == null ? "Invalid token \\\"{0}\\\". Was expecting one of: {1}." : getSACParserMessages().getString("invalidExpectingMore");
        int maxSize = 0;
